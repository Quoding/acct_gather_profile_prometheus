...
# src/plugins/acct_gather_profile/prometheus/Makefile.  Generated from Makefile.in by configure.
...
subdir = src/plugins/acct_gather_profile/prometheus
...
am__DEPENDENCIES_1 =
acct_gather_profile_prometheus_la_DEPENDENCIES =  \
	$(am__DEPENDENCIES_1)
am_acct_gather_profile_prometheus_la_OBJECTS =  \
	acct_gather_profile_prometheus.lo
acct_gather_profile_prometheus_la_OBJECTS =  \
	$(am_acct_gather_profile_prometheus_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 = 
acct_gather_profile_prometheus_la_LINK = $(LIBTOOL) $(AM_V_lt) \
	--tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=link \
	$(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(acct_gather_profile_prometheus_la_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__depfiles_remade = ./$(DEPDIR)/acct_gather_profile_prometheus.Plo
am__mv = mv -f
...
am__v_CCLD_1 = 
SOURCES = $(acct_gather_profile_prometheus_la_SOURCES)
DIST_SOURCES = $(acct_gather_profile_prometheus_la_SOURCES)
...
ACLOCAL = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/missing autoconf
AUTOHEADER = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/missing autoheader
AUTOMAKE = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/missing automake-1.16
AWK = gawk
BGQ_LOADED = 
BG_INCLUDES = 
BG_LDFLAGS = 
...
CFLAGS = -g -O2 -pthread -ggdb3 -Wall -g -O1 -fno-strict-aliasing
CHECK_CFLAGS = 
CHECK_LIBS = 
CPP = gcc -E
CPPFLAGS = 
...
GREP = /usr/bin/grep
GTK_CFLAGS = -I/usr/include/gtk-2.0 -I/usr/lib64/gtk-2.0/include -I/usr/include/pango-1.0 -I/usr/include/glib-2.0 -I/usr/lib64/glib-2.0/include -I/usr/include/fribidi -I/usr/include/harfbuzz -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/uuid -I/usr/include/cairo -I/usr/include/pixman-1 -I/usr/include/gdk-pixbuf-2.0 -I/usr/include/libmount -I/usr/include/blkid -I/usr/include/atk-1.0 -pthread 
GTK_LIBS = -lgtk-x11-2.0 -lgdk-x11-2.0 -lpangocairo-1.0 -latk-1.0 -lcairo -lgdk_pixbuf-2.0 -lgio-2.0 -lpangoft2-1.0 -lpango-1.0 -lgobject-2.0 -lfontconfig -lfreetype -pthread -lgthread-2.0 -lglib-2.0 
H5CC = 
H5FC = 
HAVEMYSQLCONFIG = no
HAVE_MAN2HTML = 
...
LIB_SLURMDB = -Wl,-rpath=${exec_prefix}/lib/slurm -L$(top_builddir)/src/api/.libs -L$(top_builddir)/src/db_api/.libs -lslurmdb -lslurmfull
...
LZ4_LIBS = 
MAINT = #
MAKEINFO = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/missing makeinfo
MANIFEST_TOOL = :
...
SLURM_MINOR = 11
SLURM_PREFIX = 
SLURM_VERSION_NUMBER = 0x110b0d
SLURM_VERSION_STRING = 17.11.13-2
SSH2_CPPFLAGS = 
SSH2_LDFLAGS = 
SSH2_LIBS = 
SSL_CPPFLAGS = 
...
ZLIB_LIBS = -lz
_libcurl_config = 
abs_builddir = /home/quo/git/slurm-slurm-17-11-13-2/src/plugins/acct_gather_profile/prometheus
abs_srcdir = /home/quo/git/slurm-slurm-17-11-13-2/src/plugins/acct_gather_profile/prometheus
abs_top_builddir = /home/quo/git/slurm-slurm-17-11-13-2
abs_top_srcdir = /home/quo/git/slurm-slurm-17-11-13-2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = 
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/quo/git/slurm-slurm-17-11-13-2/auxdir/install-sh
...
$(srcdir)/Makefile.in: # $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/plugins/acct_gather_profile/prometheus/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/plugins/acct_gather_profile/prometheus/Makefile
...
acct_gather_profile_prometheus.la: $(acct_gather_profile_prometheus_la_OBJECTS) $(acct_gather_profile_prometheus_la_DEPENDENCIES) $(EXTRA_acct_gather_profile_prometheus_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(acct_gather_profile_prometheus_la_LINK) -rpath $(pkglibdir) $(acct_gather_profile_prometheus_la_OBJECTS) $(acct_gather_profile_prometheus_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/acct_gather_profile_prometheus.Plo # am--include-marker
...
distclean: distclean-am
		-rm -f ./$(DEPDIR)/acct_gather_profile_prometheus.Plo
	-rm -f Makefile
